...
// MongoDB setup
mongoose.connect('mongodb+srv://rakshitharakshitha6242:raksh@cluster0.rdl2otz.mongodb.net/milestone', { useNewUrlParser: true, useUnifiedTopology: true })
...
app.use(session({
  ...
  store: MongoStore.create({
    mongoUrl: 'mongodb+srv://rakshitharakshitha6242:raksh@cluster0.rdl2otz.mongodb.net/milestone',
...
passport.use(new GoogleStrategy({
    clientID: '507564605628-d6s4lrod197vg9a6d7i15ulnh2nlsub3.apps.googleusercontent.com',
    clientSecret: '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',
